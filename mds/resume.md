...
| 语言/工具/平台        | 相对评分   |  备注  |
| - | -  | -  |
| Node.js/JavaScript/ES6    | ★★★★☆|深入了解
| Linux        |    ★★★★    |  熟练使用  |
| Express  |   ★★★★   |  熟练使用   |
| MongoDB/PostgreSQL  |   ★★★   |  有使用经验，熟练程度一般    |
| TCP/HTTP编程        |    ★★★   |  有使用经验，熟练程度一般  |
| C/JAVA        |    ★★★      |  有使用经验，熟练程度一般    |
| 数学/算法  |    ★★☆   |  最大的兴趣爱好  |
| SAS        |    ☆   |  1年+生产使用经验  |
...
|时间|机构|职位|职责    
|-|-|-|-|  
|2018/4至今|卖家宝科技|Node.js工程师|产品部后台主程 
|2017/8~2018/1|广东环保技工学校|教师|教授《C语言程序设计》等课程  
|2014/6~2017/4|深圳恒拓高科|Node.js工程师|轻应用小组后台主程  
