...
* 注意**Quorum不一定是大多数**，Quorum的核心是有**重叠**，这样即使不是大多数的情况下依然能够返回最新数据
* 遵循这些 $R$ 值和 $W$ 值的读写称为 **法定人数（quorum）** 的读和写
* 在实际应用的时候，n并不是指集群内全部节点，可能集群有m个节点，但是quorum只能应用在**制定的n个节点**中，在[宽松quorum和提示移交](https://github.com/Vonng/ddia/blob/master/ch5.md#%E5%AE%BD%E6%9D%BE%E7%9A%84%E6%B3%95%E5%AE%9A%E4%BA%BA%E6%95%B0%E4%B8%8E%E6%8F%90%E7%A4%BA%E7%A7%BB%E4%BA%A4)有暗示过这点。
