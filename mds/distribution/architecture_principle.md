...
关于这一章必须看**[《软件架构：架构模式、特征及实践指南》](https://item.jd.com/13303352.html#none)**这本书。自此，架构、微服务、DDD3个概念之间的层次结构算是完全确定了，如下所示：
...
关于分层一定要参考《企业架构模式》，这本书上原文就有：

> 全书实际上就是关于如何将企业应用组织成不同的层次
