...
首先要理解什么是MVC，可以参考[这里](https://www.liaoxuefeng.com/wiki/1252599548343744/1266264917931808)
> ```ascii
>                    ┌───────────────────────┐
...
另外，M一直都是指业务无关的模型，而个人却误将它和处理业务逻辑的service关联起来了，导致之前一直不能很好理解MVC，根本原因还是没有注意到它**只是个变现层的设计模式**。
